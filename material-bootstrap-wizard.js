...
function LoadExcel(evt) {
    ...
    $.ajax({
        ...
        complete: function (response) {
            var columns = response.responseJSON;
        },
    ...
    $('#cbxSource').change(function(){
        ...
        switch (this.value) {
            ...
            case "Excel":
                ...
                innerHtml = "<input id='excel' onchange='LoadExcel(event)' type='file' accept='application/vnd.ms-excel' class='btn-next btn-fill btn-danger btn-wd' name='Load Excel' value='Load Excel' />";
                break;
